...
/**
 * immutable serializable event representing an enriched logging event 
 * with
 * - additionnal name-value properties,
 * - CallStack info (applicative CallStackElt path, CallStackElt parameter)
...
public class LoggingEventExt implements Serializable {
    ...
    public LoggingEventExt(long timeStamp, LogLevel level, String threadName, String loggerName, String message,
	    Object[] argumentArray, String formattedMessage, IThrowableProxy throwable, String[] callStackPath,
	    Map<String, Object> props, Map<String, Object> params) {
	...
	public LoggingEventExt build() {
	    return new LoggingEventExt(timeStamp, level, threadName, loggerName, message, argumentArray,
		    formattedMessage, throwable, callStackPath, props, params);
	}
	...
	public Builder withProps(String key, Object value) {
	    if (this.props == null)
		this.props = new HashMap<String, Object>();
