...
public class BulkAsyncSenderTest {
	...
	protected static class InMemoryBulkEventSender<T> implements EventSender<T> {
	...
	private void waitImmediateFlush(BulkAsyncSender<E> sut, boolean flushPartialBulk) {
