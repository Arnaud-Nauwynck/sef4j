...
public class BasicStatPropTreeValueProviderDef extends ExportFragmentsProviderDef implements Serializable {
	...
	public BasicStatPropTreeValueProviderDef(PropTreeRootNodeDef rootNodeDef) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BasicStatPropTreeValueProviderDef other = (BasicStatPropTreeValueProviderDef) obj;
		if (rootNodeDef == null) {
