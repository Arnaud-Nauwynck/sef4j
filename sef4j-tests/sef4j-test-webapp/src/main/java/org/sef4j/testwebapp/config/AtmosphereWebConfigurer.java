...
/**
 * Configures an {@link AtmosphereServlet} into {@link ServletContext}.
 */
@Configuration
public class AtmosphereWebConfigurer implements ServletContextInitializer {

	private static final String annotationPackageName = "org.sef4j.testwebapp";
	...
	private void configureAthmosphere(AtmosphereServlet servlet, ServletContext servletContext) {
		...
		atmosphereServlet.setInitParameter(ApplicationConfig.ANNOTATION_PACKAGE, annotationPackageName);
