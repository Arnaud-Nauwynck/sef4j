 ...
 * <p/>
 * 
 * the DEFAULT_FACTORY is a default, for using javax.net.HttpURLConnection (jdk)
 * implementation <br/>
...
public interface HttpPostBytesSenderFactory {
	...
	@Override
	public HttpPostBytesSender create(String displayName, URL url, String contentType,
