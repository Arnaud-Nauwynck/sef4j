...
import org.sef4j.core.appenders.InMemoryCyclicEventAppender;

public class InMemoryCyclicEventAppenderTest {

    private InMemoryCyclicEventAppender<Integer> sut = new InMemoryCyclicEventAppender<Integer>();
