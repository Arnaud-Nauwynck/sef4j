...
public class AsyncChangeCollectorSender<T,E> {
	...
	public AsyncChangeCollectorSender(
			...
			AbstractPropTreeValueChangeCollector<T> changeCollector,
	...
	public static class Builder<T,E> {
		...
		private ChangeCollectorToEventSenderTask<T,E> task;
		private IPropTreeValueChangeCollector<T> taskChangeCollector;
		...
		public Builder<T,E> withTaskChangeCollector(IPropTreeValueChangeCollector<T> taskChangeCollector) {
	...
	public static class ChangeCollectorToEventSenderTask<TValue,E> implements Runnable {
		...
		private IPropTreeValueChangeCollector<TValue> changeCollector;
		private Function<Map<String,TValue>,E> changesToEventBuilder;
		private EventSender<E> targetEventSender;
		
		// ------------------------------------------------------------------------

		public ChangeCollectorToEventSenderTask(IPropTreeValueChangeCollector<TValue> changeCollector,
