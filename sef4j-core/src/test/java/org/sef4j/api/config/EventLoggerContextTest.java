...
public class EventLoggerContextTest {
    ...
    private EventAppender<E> appender1 = new InMemoryEventAppender<E>();
    private EventAppender<E> appender2 = new InMemoryEventAppender<E>();
	...
	EventAppender<E>[] abcdAppenders = sut.getInheritedAppendersFor("a.b.c.d");
	Assert.assertEquals(1, abcdAppenders.length);
	Assert.assertSame(appender2, abcdAppenders[0]);

	EventAppender<E>[] azAppenders = sut.getInheritedAppendersFor("a.z");
	Assert.assertSame(aAppenders, azAppenders);// memory optim check.. share array res

	EventAppender<E>[] abczAppenders = sut.getInheritedAppendersFor("a.b.c.z");
	Assert.assertSame(abcAppenders, abczAppenders);// memory optim check.. share array res

	EventAppender<E>[] abcdzAppenders = sut.getInheritedAppendersFor("a.b.c.d.z");
