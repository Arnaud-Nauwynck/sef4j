...
import org.sef4j.core.utils.adapters.TypeHierarchyToObjectMap;
 ...
 */
public class Slf4jLogCallerEventSender<T> implements EventAppender<T> {

    private Logger slf4jLogger;

    /**
     * class -> converter for event to method call of
     * <code>slf4jLogger.loXX(YY, ZZ)</code>
     */
    private TypeHierarchyToObjectMap<EventToSlf4jLogCaller<T>> eventToSlf4jLogCallerPerClass;

    /**
     * converter for event object to method call of
     * <code>slf4jLogger.loXX(YY, ZZ)</code>
     */
	...
	EventToSlf4jLogCaller<T> logCaller = null;
    ...
    public void setEventToSlf4jLogCallerPerClass(
	    TypeHierarchyToObjectMap<EventToSlf4jLogCaller<T>> eventToSlf4jLogCallerPerClass) {
	this.eventToSlf4jLogCallerPerClass = eventToSlf4jLogCallerPerClass;
    }
